...
('USER-ADM-01','admin@ybbfoundation.com','$2y$10$/ZjTvk1499L86TD2zzMWouq0s5n6uX1GLMLnvCB2GjQJO/VNXuisq',1,1,1653553647,1652684343,0),
('USR-MHNDR-b6331','ngodingin.indonesia@gmail.com','$2y$10$Hbah8Lalpn97Znchii.SvuoWE3RCSZUE7V1Mp.Aw9acedP6RG4Xay',0,1,1660413039,1652701295,0),
('USR-MHNDR-ff76c','mahendradwipurwanto@gmail.com','$2y$10$KSXfu/hisJJYaLFYqJ7sbO4CIRIGnEFc.yiBQHdaWGjgcAfiGNROG',2,1,0,1666622487,0);
...
('USR-MHNDR-b6331',NULL,'Admin YBB Scholarship','other','',NULL),
('USER-ADM-01',NULL,'ADMIN YBB','other',NULL,NULL),
('USR-MHNDR-ff76c',NULL,'Mahendra Dwi Purwanto',NULL,'',NULL);
