  		...
  		<div class="row content-space-t-2">
  			...
  			<div class="col-sm offset-sm-3 mb-7 mb-sm-0">
  				...
  				<ul class="list-unstyled list-py-1 mb-0">
  					...
  					<li><a class="link-sm link-light" href="<?= site_url('sponsorship');?>">Sponsorship</a></li>
  				</ul>
  				<!-- End List -->
  			</div>
  			<!-- End Col -->
  		...
  		<div class="row mb-7">
  			<div class="col-sm mb-3 mb-sm-0">
  				...
  				<ul class="list-inline list-separator list-separator-light mb-0">
  					...
  					<li class="list-inline-item">
  						<a class="link-sm link-light" href="<?= site_url('ketentuan-pengguna');?>">Ketentuan</a>
  					</li>
  				</ul>
  				<!-- End Socials -->
  			</div>
  			...
  			<div class="col-sm-auto">
  				...
  				<ul class="list-inline mb-0">
  					...
  					<li class="list-inline-item">
  						<a class="btn btn-soft-light btn-xs btn-icon"
  							href="https://twitter.com/<?= $sosmed_twitter;?>">
