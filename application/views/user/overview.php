	...
	<div class="card">
		...
		<div class="card-body">
			...
			<form class="js-step-form-validate js-validate"
				data-hs-step-form-options='{"progressSelector": "#validationFormProgress", "stepsSelector": "#validationFormContent", "endSelector": "#validationFormFinishBtn", "isValidate": true}'>
				<div class="row">
					<div class="col-3">
						<!-- Step -->
						<ul id="validationFormProgress"
							...
							<li class="step-item">
								<a class="step-content-wrapper" href="javascript:;"
									data-hs-step-form-next-options='{"targetSelector": "#formPersonalInformation"}'>
							...
							<li class="step-item">
								<a class="step-content-wrapper" href="javascript:;"
									data-hs-step-form-next-options='{"targetSelector": "#formOtherProgram"}'>
							...
							<li class="step-item">
								<a class="step-content-wrapper" href="javascript:;"
									data-hs-step-form-next-options='{"targetSelector": "#formProgramInformation"}'>
									<span class="step-icon step-icon-soft-dark">3</span>
									<div class="step-content">
										<span class="step-title">Program information</span>
									</div>
								</a>
							</li>
						</ul>
					...
					<div class="col-9">
						...
						<div id="validationFormContent">
							<div id="formPersonalInformation" class="active">
								<!-- Form Group -->
								<div class="row mb-4">
									...
									<div class="col-sm-9">
										<div class="js-form-message">
											<input type="password" class="form-control" name="username"
												id="validationFormUsernameLabel" placeholder="Username"
								...
								<!-- Form Group -->
								<div class="row mb-4">
									<label for="validationFormNewPasswordLabel"
							...
							<div id="formOtherProgram" style="display: none;">
								<!-- Form Group -->
								<div class="row mb-4">
									<label for="validationFormFirstNameLabel"
										class="col-sm-3 col-form-label form-label">First
										name</label>
								...
								<!-- Form Group -->
								<div class="row mb-4">
									<label for="validationFormLastNameLabel"
										class="col-sm-3 col-form-label form-label">Last
										name</label>

									<div class="col-sm-9">
										<div class="js-form-message">
											<input type="password" class="form-control" name="lastName"
												id="validationFormLastNameLabel" placeholder="Last name"
												aria-label="Last name" required data-msg="Please enter your last name.">
								...
								<div class="d-flex align-items-center">
									<button type="button" class="btn btn-ghost-secondary me-2"
										data-hs-step-form-prev-options='{"targetSelector": "#formPersonalInformation"}'>
							...
							<div id="formProgramInformation" style="display: none;">
								<!-- Form Group -->
								<div class="row mb-4">
									<label for="validationFormAddress1Label"
									...
									<div class="col-sm-9">
										<div class="js-form-message">
											<input type="password" class="form-control" name="address1"
												id="validationFormAddress1Label" placeholder="Address 1"
												aria-label="Address 1" required data-msg="Please enter your address.">
								...
								<div class="d-sm-flex align-items-center">
									<button type="button" class="btn btn-ghost-secondary mb-3 mb-sm-0 me-2"
										data-hs-step-form-prev-options='{"targetSelector": "#formOtherProgram"}'>
										<i class="bi-chevron-left small"></i> Previous step
									</button>
						...
						<div id="validationFormSuccessMessage" class="js-success-message" style="display:none;">
							<div class="text-center">
								<img class="img-fluid mb-3"
									src="<?= base_url();?>assets/svg/illustrations/oc-hi-five.svg"
