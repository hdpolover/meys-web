		...
		<div class="row justify-content-lg-center">
			...
			<div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
				...
				<div class="d-flex ps-md-5">
					...
					<div class="flex-grow-1 ms-3">
						<h4>MEYS Agenda</h4>
						<p style="text-align: justify;">This Middle East Youth Summit (MEYS) activity will be held on 2
							- 6
							March 2022.</p>
					</div>
				</div>
		...
		<ul class="step step-timeline-md">
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">November 1-30, 2022</h4>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">January 2, 2023</h4>
						<p class="step-text text-white-70">Payment of Batch 1</p>
					</div>
				</div>
			</li>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">February 2, 2023</h4>
						<p class="step-text text-white-70">Payment of Batch 2</p>
					</div>
				</div>
			</li>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">March 2-6, 2023</h4>
						<p class="step-text text-white-70">Middle East Youth Summit</p>
					</div>
				</div>
			</li>
		</ul>
