...
class Excel
{
    ...
    public function export_payments($data = [], $status = 'All Status')
    {
        ...
        $sheet->setCellValue('A3', 'No')
            ->setCellValue('B3', 'Name')
            ->setCellValue('C3', 'Email')
            ->setCellValue('D3', 'Method')
            ->setCellValue('E3', 'Payment Batch')
        ...
        if(!empty($data)){
            foreach ($data as $key => $val) {
                ...
                $sheet->setCellValue('A' . $row, $no)
                    ->setCellValue('B' . $row, $val->name)
                    ->setCellValue('C' . $row, $val->email)
                    ->setCellValue('D' . $row, $val->payment_method)
                    ->setCellValue('E' . $row, $val->summit)
                    ->setCellValue('F' . $row, $val->amount)
                    ->setCellValue('G' . $row, $status_txt);
